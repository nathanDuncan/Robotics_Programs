...
This particular file focuses on 2D localization of a car using particle filter.
"""
...
class Car:
    def __init__(self, L=L, W=W, R=R):
        # Initialize random position, heading, and zero steering angle
    ...
    """
    ### Functions based on bearing error 
    ...
    def measurement_prob(self, measurements):
        ...
        for pred,  eas in zip(predicted, measurements):
    ...
    ### Functions based on distance error
    ...
    def draw(self, lines):
        ...
        lines[6][0].set_data(front_right_tire[0, :], front_right_tire[1, :])
        lines[7][0].set_data(front_left_tire[0, :], front_left_tire[1, :])
        return lines
